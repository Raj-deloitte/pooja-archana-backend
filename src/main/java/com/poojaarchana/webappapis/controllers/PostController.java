...
public class PostController {
  ...
  public ResponseEntity<List<PostDto>> searchPost(@RequestParam String keywords) {
  ...
  public ResponseEntity<PostDto> uploadPostImage(@RequestParam("image")MultipartFile image, @PathVariable Long postId) throws IOException {
    ...
    PostDto uploadedImage = this.postService.updatePost(postDto, postId);
    return new ResponseEntity<PostDto>(uploadedImage, HttpStatus.OK);
  }
